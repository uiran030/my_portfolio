...
$(".slide-group").slick({
  ...
  dots: true,
  prevArrow:
    '<button class="slick-arrow slick-prev"><i class="fas fa-arrow-circle-left"></i></button>',
  nextArrow:
    '<button class="slick-arrow slick-next"><i class="fas fa-arrow-circle-right"></i></button>',
  fade: false,
  slidesToShow: 3,
  slidesToScroll: 1,
  responsive: [
